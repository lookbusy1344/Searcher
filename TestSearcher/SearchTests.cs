...
public partial class SearchTests
{
	...
	public void SearchNoMatch()
	{
		...
		var options = new Searcher.CliOptions { Search = "summer" };
	...
	public void SearchNoMatchingGlob()
	{
		...
		var options = new Searcher.CliOptions {
	...
	public void TerrorsOfTheEarth()
	{
		...
		var options = new Searcher.CliOptions { Search = "terrors of the earth" };
		var found = Helpers.SearchCaller(options);
	...
	public void ItIsTheEast()
	{
		...
		var options = new Searcher.CliOptions { Search = "it is the east" };
		var found = Helpers.SearchCaller(options);
	...
	public void PoorPlayerThatStruts()
	{
		...
		var options = new Searcher.CliOptions { Search = "poor player That struts" };
		var found = Helpers.SearchCaller(options);
	...
	public void BrownFoxNestedZip()
	{
		...
		var options = new Searcher.CliOptions { Search = "brown fox" };
		var found = Helpers.SearchCaller(options);
	...
	public void ThisDayHenryV()
	{
		...
		var options = new Searcher.CliOptions { Search = "this day" };
		var found = Helpers.SearchCaller(options);
